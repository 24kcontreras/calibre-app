import { X, ClipboardList, Fuel, AlertTriangle, ShieldAlert, Camera, Car, BatteryWarning, Droplets, AlertCircle, Thermometer, CircleDot, LifeBuoy, Settings, Zap, Wind, Activity, Search } from 'lucide-react';
            ...
            <div className="bg-slate-900/90 backdrop-blur-md border border-slate-700/50 rounded-[35px] p-6 md:p-8 w-full max-w-4xl shadow-2xl relative my-auto max-h-[90vh] overflow-y-auto custom-scrollbar-dark">
                ...
                <div className="space-y-4 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-slate-950/50 p-5 rounded-2xl border border-slate-800">
                            ...
                            <div className="relative pt-2 pb-2 px-4 flex flex-col items-center">
                                ...
                                <div className={`text-center mt-3 font-black text-xl tracking-tighter ${combustibleValue <= 15 ? 'text-red-400' : 'text-emerald-400'}`}>
                                    {combustibleValue}%
                                </div>
                            </div>
                        </div>

                        <div className="bg-slate-950/50 p-5 rounded-2xl border border-slate-800 flex flex-col">
                            <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4 flex items-center gap-2">
                    ...
                    <div className="bg-slate-950/50 p-5 rounded-2xl border border-slate-800">
                        ...
                        <p className="text-xs text-slate-300 font-bold italic text-center w-full mt-4 bg-slate-900 p-4 rounded-xl border border-slate-800">
                            {orden.danos_previos ? `"${orden.danos_previos}"` : "Carrocería sin detalles reportados."}
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-slate-950/50 p-5 rounded-2xl border border-slate-800 flex flex-col justify-center">
                            ...
                            <p className="text-sm text-slate-300 font-bold italic bg-slate-900 p-4 rounded-xl border border-slate-800">
